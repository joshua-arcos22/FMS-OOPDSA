 ...
 * @author Joshua
 */
public class q400 extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(q400.class.getName());
    ...
    public q400(String Fl_number, String currentUserName) {
        initComponents();
        intializeComboBoxes();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\Joshua\\Documents\\NetBeansProjects\\FlightManagementSystemChanges\\LipadBantayOOPDSA\\src\\main\\java\\com\\mycompany\\lipadbantayoopdsa\\resources\\q400.png")); // NOI18N
    ...
    public void intializeComboBoxes(){
        ...
        SeatCat.removeAllItems();
        SeatCat.addItem("Collumn A");
        SeatCat.addItem("Collumn B");
        SeatCat.addItem("Collumn C");
        SeatCat.addItem("Collumn D");

        
        SeatCat.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                updateSeatNumbers();
            }
        });
    ...
    private void updateSeatNumbers() {
            String selectedCat = (String) SeatCat.getSelectedItem();
            SeatNum.removeAllItems();

            int limit = 0;
            if (selectedCat.equals("A") || selectedCat.equals("B")) {
                limit = 20;
            } else {
                limit = 18;
            }
            ...
            for (int i = 1; i <= limit; i++) {
                SeatNum.addItem(String.valueOf(i));
            }
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new q400().setVisible(true));
    }
