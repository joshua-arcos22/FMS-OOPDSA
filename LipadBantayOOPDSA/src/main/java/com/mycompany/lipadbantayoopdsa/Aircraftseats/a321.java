...
public class a321 extends javax.swing.JFrame {
    ...
    private String[] takenSeatsArray = new String[240];
    ...
    public a321(String flightNum, int seatsNeeded, String partialRecord, String username, String price) {
    ...
    private void updateSeatNumbers(JComboBox<String> catBox, JComboBox<String> numBox) {
        ...
        int limit = 40; // This is the rwos chanegs this if there is an update towards the airarcfts.txt 
