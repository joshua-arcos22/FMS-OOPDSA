 ...
 * @author Joshua
 */
public class b777 extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(b777.class.getName());
    ...
    private String[] takenSeatsArray = new String[550];
    ...
    public b777(String flightNum, int seatsNeeded, String partialRecord, String username, String price) {
    ...
    private void setupComboBoxes(JComboBox<String> catBox, JComboBox<String> numBox) {
        ...
        int limit = 55; // This is the rwos chanegs this if there is an update towards the airarcfts.txt 
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new b777().setVisible(true));
    }
