 ...
 * @author Joshua
 */
public class atr72 extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(atr72.class.getName());
    ...
    private String[] takenSeatsArray = new String[76];
    ...
    public atr72(String flightNum, int seatsNeeded, String partialRecord, String username, String price) {
    ...
    private void updateSeatNumbers(JComboBox<String> catBox, JComboBox<String> numBox) {
        ...
        int limit = 19; // This is the rwos chanegs this if there is an update towards the airarcfts.txt 
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new atr72().setVisible(true));
    }
