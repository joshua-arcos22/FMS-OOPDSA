...
public class archiveScreen extends javax.swing.JFrame {
    ...
    public void loadArchiveData() {
        ...
        if (!file.exists()) {
            try {
                ...
                System.out.println("File Does not exist Created arrivals");
            }
            return;
        }
    ...
    public void applyFilters() {
        ...
        for (String filePath : filesToFilter) {
            ...
            try (BufferedReader br = new BufferedReader(new FileReader(file))) {
                ...
                System.out.println("Error in Filtering Flights");
            }
        }
    }
    ...
    private void restoreLineToMain(String flightNum) throws IOException {
        ...
        try (Scanner scanner = new Scanner(archiveFile); 
            ...
            System.out.println("Error inrestoring Entry");
        }
    }
    ...
    private void deleteLineFromFile(String filePath, String flightNumberToRemove) throws IOException {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(inputFile)); 
            ...
            System.out.println("Error in wiriting the Temp and INput file");
        }
