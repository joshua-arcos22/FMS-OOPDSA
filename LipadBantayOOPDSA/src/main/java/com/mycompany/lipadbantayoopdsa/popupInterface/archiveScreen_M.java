 ...
 * @author Joshua
 */
public class archiveScreen_M extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(archiveScreen_M.class.getName());
    ...
    private void backActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backActionPerformed
        MainFlightDisplayManagers mainDisplay = new MainFlightDisplayManagers(currentAirlineName, currentAirlinePrefix);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new archiveScreen_M().setVisible(true));
    }
