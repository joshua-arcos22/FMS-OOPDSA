...
public class editFlightScreen_1 extends javax.swing.JFrame {
        ...
        public editFlightScreen_1(
            ...
            try {
                ...
                while (scanner.hasNextLine()) {
                    ...
                    if (!line.trim().isEmpty()) {
                        ...
                        origin_drpdwn.addItem(parts[1] + "(" + parts[0] + ")");
                    }
                }
            } catch (FileNotFoundException e) {
            ...
            try {
                ...
                while (scanner.hasNextLine()) {
                    ...
                    if (!line.trim().isEmpty()) {
                        String[] parts = line.split("-");
                        destination_drpdwn.addItem(parts[1] + "(" + parts[0] + ")");
                    }
                }
            } catch (FileNotFoundException e) {
                System.out.println("Airport File not found");
            ...
            for (int i = 0; i < destination_drpdwn.getItemCount(); i++) {
                if (destination_drpdwn.getItemAt(i).contains(destination)) {
                    destination_drpdwn.setSelectedIndex(i);
                    break;
                }
            }
    ...
    private void updateRunwayStatus() {
        ...
        if (originRaw.equals(destRaw)) {
            ...
            try {
                ...
                System.out.println("Airport DB Error");
            }
        }
    ...
    public static void main(String args[]) {
        ...
        /* Create and display the form standard fallback values*/
